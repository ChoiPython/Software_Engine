...
| 파일 | 내용 |
|---|---|
| [1_프로젝트계획서.hwp](docs/1_프로젝트계획서.hwp) | 주제/목표, 시장 분석, 개발 모델 선정 근거, WBS, 간트 차트, 비용(FP) 산정 |
| [1_프로젝트계획서_발표자료.pptx](docs/1_프로젝트계획서_발표자료.pptx) | 계획서 발표 슬라이드 |
| [req_01_메뉴선택.hwp](docs/req_01_메뉴선택.hwp) | 메뉴 선택 유스케이스 |
| [req_02_장바구니수정.hwp](docs/req_02_장바구니수정.hwp) | 장바구니 수정 유스케이스 |
| [req_03_사용자주문목록조회.hwp](docs/req_03_사용자주문목록조회.hwp) | 주문 목록 조회 유스케이스 |
| [req_04_메뉴등록.hwp](docs/req_04_메뉴등록.hwp) | 메뉴 등록 유스케이스 |
| [req_05_메뉴수정.hwpx](docs/req_05_메뉴수정.hwpx) | 메뉴 수정 유스케이스 |
| [req_06_메뉴삭제.hwp](docs/req_06_메뉴삭제.hwp) | 메뉴 삭제 유스케이스 |
| [req_07_카테고리등록.hwp](docs/req_07_카테고리등록.hwp) | 카테고리 등록 유스케이스 |
| [req_08_카테고리수정.hwp](docs/req_08_카테고리수정.hwp) | 카테고리 수정 유스케이스 |
| [req_09_카테고리삭제.hwp](docs/req_09_카테고리삭제.hwp) | 카테고리 삭제 유스케이스 |
| [req_10_관리자주문현황조회.hwp](docs/req_10_관리자주문현황조회.hwp) | 관리자 주문 현황 조회 유스케이스 |
| [3_설계보고서.hwpx](docs/3_설계보고서.hwpx) | 클래스 다이어그램·클래스 명세서, 시퀀스 다이어그램, ER 다이어그램, 테이블 설계 |
| [3_시퀀스다이어그램.uml](docs/3_시퀀스다이어그램.uml) | 시퀀스 다이어그램 원본 (StarUML) |
| [4_최종보고서.hwpx](docs/4_최종보고서.hwpx) | 계획서~구현~실행결과 전체 통합 보고서, 팀원별 소감문 |
| [4_최종발표자료.pptx](docs/4_최종발표자료.pptx) | 최종 발표 슬라이드 (실행 화면 스크린샷 다수 포함) |

> ⚠️ 클릭하면 GitHub이 파일을 바로 보여주는 게 아니라 **다운로드 페이지로 이동**합니다. `.hwp`/`.hwpx`는 한글과컴퓨터(한글 뷰어)로, `.uml`은 StarUML 등에서 열어야 내용을 볼 수 있어요. GitHub은 이 포맷들을 브라우저에서 미리보기 해주지 않습니다.
